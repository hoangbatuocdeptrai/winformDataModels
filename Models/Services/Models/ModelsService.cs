...
namespace Models.Services
{
    public class ModelsService : IModelsService
    {
        ...
        {
            var sql = await _dbservice.CreateData("INSERT INTO public.models(modelsname, quantity, created_at, updated_at) VALUES(@modelsname, @quantity, @created_at, @updated_at)", models);
            return true;
        }
